...
def graph():
   ...
   if request.form.get('Open'):
      p.line(df1['index'], df1['Open'], line_width=2, line_color='blue', legend='Open')

   if request.form.get('Close'):
      p.line(df1['index'], df1['Close'], line_width=2, line_color='green', legend='Close')
   ...
   return render_template('graph.html', script=script, div=div, title=app.vars['symbol'])
